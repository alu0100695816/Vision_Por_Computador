       ...
       class MenuDemo implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			// -----Op. Geom
				...
				tamV = Integer.parseInt(JOptionPane.showInputDialog("Tama̱o vertical de la imagen: " + ((FrameInterno)(panel.getSelectedFrame())).getImg().getTam()[1] + "px. Introduzca el nuevo tama̱o vertical:"));
